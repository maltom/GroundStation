...
{
    if(cameraPic->isOpened()) cameraPic->release();
    delete cameraPic;
}
...
//        return;
    ...
    process();
    QImage output((uchar*)originalFrame.data, originalFrame.cols, originalFrame.rows, originalFrame.step, QImage::Format_RGB888);
