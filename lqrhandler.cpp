...
void LQRHandler::calculateKMatrix()
{
    ...
    // std::cout<<"Oto
    // QRABiK"<<std::endl<<Q<<std::endl<<std::endl<<R<<std::endl<<std::endl<<A<<std::endl<<std::endl<<B<<std::endl<<std::endl<<K<<std::endl<<std::endl;;
...
void LQRHandler::update()
{
    ...
    this->rovPosition->setPositionAndVelocity( "current",
                                               { simulationResultState[ 0 ],
    ...
    posToSim << simulationResultState[ 0 ], simulationResultState[ 1 ], simulationResultState[ 2 ],
        simulationResultState[ 3 ], simulationResultState[ 4 ], simulationResultState[ 5 ];
