...
rosNodeHandler::rosNodeHandler( QObject* parent ) : QObject( parent )
{
    ...
    // this->regulatorReceiver =
    // nodeHandler.subscribe("/gupik/position/rov_fdbck",1000,&rosNodeHandler::sendKToRegulator,this);
    this->mainCameraReceiver
        = nodeHandler.subscribe( "/gupik/camera/mainCamera/image_raw", 100, &rosNodeHandler::sendRosCameraFrame, this );
}
