...
void positionData::setPositionAndVelocity(
...
void positionData::setPositionAndVelocity( std::string time,
                                           double x,
                                           double y,
                                           double z,
                                           double roll,
...
void positionData::recalculateSpaceMousePosition( void )
{
    ...
    for( int i = 0; i < 6; ++i )
    {
        ( ( *point < 0 ) && ( n % 2 == 0 ) ) ? ( *point = -std::pow( *point / 3.5, n ) / std::pow( 10, n ) ) :
...
void positionData::addToPositionAndVelocity(
    std::string time, double x, double y, double z, double roll, double pitch, double yaw )
{
    posAndVel* container = nullptr;
...
void positionData::addToPositionAndVelocity( std::string time,
                                             double x,
                                             double y,
                                             double z,
                                             double roll,
...
void positionData::getDifference(
    std::string time, positionData& A, std::string timeA, positionData& B, std::string timeB )
{
